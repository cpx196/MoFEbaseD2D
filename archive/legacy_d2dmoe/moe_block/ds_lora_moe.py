...
class DS_LR_MoE(nn.Module):
    ...
    def forward(self, x):
        ...
        final_lr1_A = self.lr1_A.to(device)
        final_lr1_B = self.lr1_B.to(device)
        final_lr2_A = self.lr2_A.to(device)
        final_lr2_B = self.lr2_B.to(device)
